...
c b c <option %s>Browser</option><option %s>Running Lights</option><option %s>Alarma</option></select></td></tr>
t <tr><td><img src=pabb.gif>LED diode ports [5..0]:</td>
...
c b 5 <td><input type=checkbox name=led5 OnClick="submit();" %s>AZUL</td>
c b 4 <td><input type=checkbox name=led4 OnClick="submit();" %s>VERDE</td>
t <td width="5%"></td>
c b 3 <td><input type=checkbox name=led3 OnClick="submit();" %s>ROJO</td>
c b 2 <td><input type=checkbox name=led2 OnClick="submit();" %s>LED3</td>
c b 1 <td><input type=checkbox name=led1 OnClick="submit();" %s>LED2</td>
c b 0 <td><input type=checkbox name=led0 OnClick="submit();" %s>LED1</td>
t </font></table></td></tr>
